...
# Read from Zeabur env vars — set in dashboard, NOT in code
SECRET_KEY      = os.environ.get("HL_SECRET_KEY")
ACCOUNT_ADDRESS = os.environ.get("HL_ACCOUNT_ADDRESS")

if not SECRET_KEY or not ACCOUNT_ADDRESS:
    raise ValueError("HL_SECRET_KEY and HL_ACCOUNT_ADDRESS must be set in Zeabur Variables")
...
if __name__ == "__main__":
    # Zeabur injects PORT env var — must use 0.0.0.0
